variable "tenancy_ocid" {default = "ocid1.tenancy.oc1..q"}
variable "user_ocid" {default = "ocid1.user.oc1..aaa"}
variable "fingerprint" {default = "de:...d6"}
variable "private_key_path" {default = "/Users/shadab/.oci/oci_api_key.pem"}
variable "compartment_id" {default = "ocid1.compartment.oc1..aaaa"}
variable "region" {default = "af-johannesburg-1"}
